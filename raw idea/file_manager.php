		...
		*/
		...
		private function __validateFileParam($needle, $haystack)
		{
			try
			{
				...
				{
					//an array object is expected, we need a method for handling exceptions probably
                    //(an external class that implements or inherits the base Exception methods from PHP)
